...
func TestInstallGem(t *testing.T) {
	...
	wantHistory := []string{
		"sudo yum update -y",
		"sudo yum install -y epel-release gcc-c++ patch readline readline-devel zlib zlib-devel libffi-devel openssl-devel make bzip2 autoconf automake libtool bison sqlite-devel",
